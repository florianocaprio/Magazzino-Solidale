...
| GEO-01  | M1B               | OK-M1B/NE-MAN        | Suite completa e fixture A1=10, A2=20, B1=40, legacy null, precisione, prenotazioni, scadenze e lotti attivi superate; validazione manuale pendente.                    |
| GEO-02  | M1B               | OK-M1B/NE-MAN        | Intersezione Area/Centro/comune e tentativi 400/403/404 verificati lato backend; validazione manuale pendente.                                             |
| GEO-03  | M1B               | OK-M1B/NE-MAN        | Selettore Area→Magazzino, reset, query key e protezione dalla risposta tardiva verificati; validazione manuale pendente.                                    |
| GEO-04  | M1B               | OK-M1B/NE-MAN/APP-M0 | Soglie Area assenti, sottoscorta solo Magazzino e parità tabella/export verificate; validazione manuale pendente.                                           |
...
| CAT-01  | M1B/M2            | OK-M1B/NE-MAN        | Suite e ispezione confermano Catalogo `/prodotti` globale, senza proprietà/filtro Area; validazione manuale pendente.                                              |
