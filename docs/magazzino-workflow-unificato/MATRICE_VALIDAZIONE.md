...
| DB-01   | M2+               | OK-M1C                   | Hardening applicato su copia popolata da 34 a 35 migrazioni; 37 movimenti e dati business invariati, nessun audit retroattivo, replay 35/35 skip. Ripetere a ogni schema nuovo.   |
| DB-02   | M0/M2+            | OK-TEST-M0/OK-M1C        | Fresh gate M1C da DB vuoto con schema, 35 migrazioni, nuovo vincolo, seed, login, CRUD, replay, checksum e 0 pending/mismatch/out-of-order superato.                              |
...
| REG-01  | ogni milestone/M6 | OK-TEST-M0/OK-M1C/NE-M6  | Hardening M1C: test mirati, suite API completa, migration runner, codegen e typecheck verdi; frontend/build precedenti restano validi. Regressione integrata finale M6 pendente.  |
