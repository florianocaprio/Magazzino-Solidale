...
| Area                | Chiusura R2                                                  | Gate                                  |
| ------------------- | ------------------------------------------------------------ | ------------------------------------- |
| Replay/export vuoti | scope hash pre-coverage e `NESSUN_DATO_DA_RENDICONTARE`      | replay concorrente e overlap          |
| Coverage            | event/line key più content hash, late-line correction        | acceptance A/B/C/D/L2                 |
| Operazioni          | immutabili dopo il primo Movimento                           | payload identico/differente           |
| Workbook            | apertura e saldo progressivo fixed-point snapshot            | 100 → -10 = 90 e stabilità fonti live |
| Riconciliazione     | righe active/superseded/companion univoche                   | DISABBINA/RIAPRI/doppio ABBINA        |
| Delta AGEA          | nuovo, modificato, scomparso e locale retrodatato            | multinsieme/cutoff                    |
| Migration ledger    | `20260826_magazzino_2_0c_r2_acceptance_hardening.sql` NORMAL | 1 pending, 1 applied, secondo run 0   |
