...
- **How to apply:** apply the same centro+Area Operativa IDOR guard as the rest of the router (via beneficiario), and surface the action only on non-`effettuata` rows behind an AlertDialog confirm.
