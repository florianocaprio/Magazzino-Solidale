...
for (const operation of ["analyzeAgeaImportazione", "analyzeVolontariImport"]) {
  ...
  if (occurrences !== 1) {
    throw new Error(`Expected exactly one Orval binary-body serialization for ${operation}, found ${occurrences}`);
  }
