...
export const sessioniCassaEmporioRigheTable = pgTable(
  "sessioni_cassa_emporio_righe",
  {
    ...
    giacenzaDisponibileAlMomento: decimal("giacenza_disponibile_al_momento", {
      precision: 10,
      scale: 2,
    }),
    limitePerSpesa: decimal("limite_per_spesa", { precision: 10, scale: 2 }),
    limiteMensile: decimal("limite_mensile", { precision: 10, scale: 2 }),
    superaLimitePerSpesa: boolean("supera_limite_per_spesa")
      .notNull()
      .default(false),
    superaLimiteMensile: boolean("supera_limite_mensile")
      .notNull()
      .default(false),
...
export type SessioneCassaEmporioRiga =
  typeof sessioniCassaEmporioRigheTable.$inferSelect;
