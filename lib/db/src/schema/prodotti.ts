...
export const prodottiTable = pgTable(
  "prodotti",
  {
    ...
    quantitaMassimaPerSpesa: decimal("quantita_massima_per_spesa", { precision: 10, scale: 2 }),
    quantitaMassimaMensile: decimal("quantita_massima_mensile", { precision: 10, scale: 2 }),
