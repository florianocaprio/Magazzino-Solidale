...
- Ogni `mense` appartiene a una `citta` e collega in modo univoco un `magazzini` attivo già configurato esplicitamente come tipo `mensa`; la creazione non converte magazzini logistici esistenti. Prodotti, lotti, scadenze, FEFO, movimenti, trasferimenti e PDF restano quelli logistici esistenti.
