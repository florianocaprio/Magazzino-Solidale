export const MENSA_PERMISSIONS = [
  ...
  { key: "mensa.exceptions.manage", label: "Mensa: eccezioni nella stessa Area" },
...
export const BENEFICIARI_PERMISSIONS = [
  { key: "beneficiari.view", label: "Beneficiari: consultazione directory e anagrafica" },
  { key: "beneficiari.manage", label: "Beneficiari: gestione anagrafica" },
  { key: "beneficiari.sensitive.view", label: "Beneficiari: consultazione dossier sensibile" },
  { key: "beneficiari.deactivate", label: "Beneficiari: disattivazione e riattivazione" },
  { key: "beneficiari.export", label: "Beneficiari: esportazione dati" },
  { key: "beneficiari.duplicates.search", label: "Beneficiari: ricerca anti-duplicato" },
  {
...
export const CREDITO_PERMISSIONS = [
  ...
  { key: "credito.quota.manage", label: "Credito Solidale: gestione quota assegnata" },
  { key: "credito.adjust", label: "Credito Solidale: ricariche, rettifiche e storni" },
  { key: "credito.monthly.execute", label: "Credito Solidale: esecuzione ricariche mensili" },
] as const;
