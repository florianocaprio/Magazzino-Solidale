...
import lottiLogiciRouter from "./lotti-logici";
import carichiRouter from "./carichi";
import caricoPraticheRouter from "./carico-pratiche";
...
import volontariOperazioniRouter from "./volontari-operazioni";
import volontariFormazioneRouter from "./volontari-formazione";
import volontariImportRouter from "./volontari-import";
import volontariExportRouter from "./volontari-export";
...
import beneficiariFseRouter from "./beneficiari-fse";
import interventiRouter from "./interventi";
import consegneRouter from "./consegne";
import bolleRouter from "./bolle";
import entiDestinatariRouter from "./enti-destinatari";
import documentiOperativiRouter from "./documenti-operativi";
...
router.use(lottiLogiciRouter);
router.use(carichiRouter);
router.use(caricoPraticheRouter);
router.use(movimentiRouter);
router.use(giacenzeRouter);
router.use(preparazioneConsegneRouter);
// Route Volontari 2.0 specifiche prima del fallback REST /volontari/:id.
router.use(volontariOperazioniRouter);
router.use(volontariFormazioneRouter);
router.use(volontariImportRouter);
router.use(volontariExportRouter);
