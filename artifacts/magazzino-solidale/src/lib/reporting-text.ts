...
const reportingTextKeys: Record<string, string> = {
  ...
  "La quantità FSE+ deriva dai Movimenti scaricati con snapshot Fondo FSE_PLUS.": "parcelFseLots",
  ...
  "La provenienza FSE+ deriva dallo snapshot Fondo dei Movimenti della spesa.": "emporioFseLot",
  ...
  "La provenienza FSE+ è determinata esclusivamente dallo snapshot Fondo del Movimento.": "fseProvenance",
  ...
  "Lo snapshot Fondo del Movimento è autorevole": "sifeadLotAuthoritative",
