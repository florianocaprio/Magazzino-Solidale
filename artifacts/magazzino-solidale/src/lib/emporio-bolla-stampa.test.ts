...
describe("stampa Bolla dal dominio Emporio", () => {
  beforeEach(() => {
    ...
    mocks.getBollaStampaSpesaEmporio.mockResolvedValue({
      ...
      numeroBolla: "B-1",
      numeroSpesa: "S-1",
      dataChiusura: "2026-08-20T22:30:00.000Z",
      dataBolla: "2026-08-21",
      ...
      righe: [
        ...
        },
        {
          id: 2,
          spesaEmporioId: 10,
          sessioneCassaRigaId: 3,
          prodottoId: 4,
          prodottoNome: "Pasta",
          lottoId: 5,
          codiceLotto: "LOT-2",
          codiceProdotto: "PROD-2",
          descrizioneProdotto: "Pasta",
          quantita: 1,
          unitaMisura: "pz",
          quantitaStornata: 0,
    ...
    expect(mocks.generateBollaPdf).toHaveBeenCalledWith(
      expect.objectContaining({
        bolla: expect.objectContaining({
          ...
          dataBolla: "2026-08-21",
          righe: [
            expect.objectContaining({ unitaMisura: "kg", fsePlus: true }),
            expect.objectContaining({ unitaMisura: "pz", fsePlus: false }),
          ],
        }),
      }),
    );
